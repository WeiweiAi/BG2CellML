...
VARIABLE_INFO = [
    ...
    {"name": "P_10", "units": "per_fmol5_sec6", "component": "SLCT8_BG_ss", "type": VariableType.COMPUTED_CONSTANT},
    {"name": "P_9", "units": "per_fmol3_sec6", "component": "SLCT8_BG_ss", "type": VariableType.COMPUTED_CONSTANT},
    {"name": "P_8", "units": "per_fmol2_sec6", "component": "SLCT8_BG_ss", "type": VariableType.COMPUTED_CONSTANT},
    ...
    {"name": "P_4", "units": "per_fmol3_sec6", "component": "SLCT8_BG_ss", "type": VariableType.COMPUTED_CONSTANT},
...
def compute_computed_constants(variables):
    ...
    variables[10] = variables[35]*variables[25]*variables[27]*pow(variables[29], 2.0)*variables[31]*variables[33]*variables[23]*pow(variables[21], 2.0)*variables[38]*variables[39]*variables[40]*variables[41]*variables[42]*variables[43]*variables[44]
    variables[11] = variables[35]*variables[25]*variables[27]*variables[29]*pow(variables[31], 2.0)*variables[33]*variables[24]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[40]*variables[41]*variables[42]*variables[43]*variables[44]
    variables[20] = variables[35]*variables[25]*variables[29]*pow(variables[31], 2.0)*variables[33]*variables[24]*variables[39]*variables[40]*variables[41]*variables[42]*variables[43]*variables[44]+variables[35]*variables[27]*variables[29]*pow(variables[31], 2.0)*variables[33]*variables[24]*variables[39]*variables[40]*variables[41]*variables[42]*variables[43]*variables[44]
    variables[19] = variables[35]*variables[25]*pow(variables[29], 2.0)*variables[31]*variables[33]*variables[24]*variables[38]*variables[40]*variables[41]*variables[42]*variables[43]*variables[44]+variables[35]*variables[27]*pow(variables[29], 2.0)*variables[31]*variables[33]*variables[24]*variables[38]*variables[40]*variables[41]*variables[42]*variables[43]*variables[44]
    variables[18] = variables[35]*variables[25]*variables[27]*variables[29]*pow(variables[31], 2.0)*variables[24]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[41]*variables[42]*variables[43]*variables[44]+6.0*variables[35]*variables[25]*variables[27]*variables[29]*variables[31]*variables[33]*variables[24]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[40]*variables[41]*variables[42]*variables[44]+variables[25]*variables[27]*variables[29]*pow(variables[31], 2.0)*variables[33]*variables[24]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[40]*variables[41]*variables[42]*variables[43]+variables[25]*variables[27]*variables[29]*pow(variables[31], 2.0)*variables[33]*variables[24]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[41]*variables[42]*variables[43]*variables[44]
    variables[17] = variables[35]*variables[25]*variables[27]*pow(variables[29], 2.0)*variables[31]*variables[23]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[40]*variables[41]*variables[42]*variables[43]+variables[35]*variables[25]*variables[27]*pow(variables[29], 2.0)*variables[31]*variables[23]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[40]*variables[42]*variables[43]*variables[44]+variables[25]*variables[27]*pow(variables[29], 2.0)*variables[31]*variables[33]*variables[23]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[40]*variables[42]*variables[43]*variables[44]
    variables[16] = variables[35]*variables[25]*variables[29]*pow(variables[31], 2.0)*variables[33]*variables[24]*pow(variables[21], 2.0)*variables[38]*variables[39]*variables[40]*variables[41]*variables[43]*variables[44]
    variables[15] = 4.0*variables[35]*variables[25]*variables[27]*variables[29]*variables[31]*variables[33]*variables[24]*pow(variables[22], 2.0)*variables[39]*variables[40]*variables[41]*variables[42]*variables[43]*variables[44]+variables[35]*variables[27]*pow(variables[29], 2.0)*variables[31]*variables[33]*variables[24]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[40]*variables[41]*variables[43]*variables[44]
    variables[14] = 4.0*variables[35]*variables[25]*variables[27]*variables[29]*variables[31]*variables[33]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[40]*variables[41]*variables[42]*variables[43]+4.0*variables[35]*variables[25]*variables[27]*variables[29]*variables[31]*variables[33]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[40]*variables[42]*variables[43]*variables[44]+4.0*variables[35]*variables[25]*variables[27]*variables[29]*variables[31]*variables[33]*pow(variables[22], 2.0)*variables[38]*variables[39]*variables[41]*variables[42]*variables[43]*variables[44]
    variables[13] = 4.0*variables[35]*variables[25]*variables[27]*variables[29]*variables[31]*variables[33]*variables[24]*pow(variables[21], 2.0)*variables[38]*variables[40]*variables[41]*variables[42]*variables[43]*variables[44]
    variables[12] = 4.0*variables[35]*variables[25]*variables[27]*variables[29]*variables[31]*variables[33]*variables[24]*pow(variables[22], 2.0)*pow(variables[21], 2.0)*variables[38]*variables[39]*variables[40]*variables[41]*variables[43]*variables[44]
    variables[9] = variables[36]+variables[26]+variables[28]+variables[30]+variables[32]+variables[34]
